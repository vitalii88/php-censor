...
PHP Censor',
    ...
    'build_config' => 'Конфигурация сборки проекта для PHP Censor (если вы не добавили файл .php-censor.yml в репозиторий вашего проекта)',
    'periodical_config' => 'Конфигурация периодической сборки проекта для PHP Censor',
