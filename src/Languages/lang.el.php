...
Services</a> του Bitbucket αποθετηρίου σας.',
    ...
    'php_mess_detector_warnings' => 'Προειδοποιήσεις PHPMD',
    'php_code_sniffer_warnings' => 'Προειδοποιήσεις PHPCS ',
    'php_code_sniffer_errors' => 'Λάθη PHPCS',
    'php_parallel_lint_errors' => 'Λάθη Lint',
    'php_unit_errors' => 'Λάθη PHPUnit ',
    'php_docblock_checker_warnings' => 'Χαμένα Docblocks',
    'issues' => 'Θέματα',

    'codeception' => 'Codeception',
    'php_cpd' => 'PHP Ανιχνευτής Αντιγραφής/Επικόλλησης',
    'php_code_sniffer' => 'Sniffer Κώδικα PHP',
    'php_docblock_checker' => 'Χαμένα Docblocks',
    'php_mess_detector' => 'Aνιχνευτής PHP Mess',
    'php_spec' => 'PHP Spec',
    'php_unit' => 'PHP Unit',
